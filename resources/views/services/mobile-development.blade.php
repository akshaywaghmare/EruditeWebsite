...
@section('content')
    ...
    <div class="innerpage-banner center parallax-bg bg-overlay-dark-7 height-500 d-flex" style="background:url({{asset('public/images/mobile-app.jpg')}}) no-repeat; background-size:cover; background-position: center center;">
		<div class="container">
			<div class="row justify-content-between align-items-center h-100">
				<div class="col-md-6 mb-4 all-text-white text-left">
					<h4>A mint of creativity</h4>
					<h1 class="product-title">Mobile App Development</h1>
...
{{--  <section class="pricing-page pricing pricing-center mt-5 pb-3">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-left">
					<h2 class="h2 font-weight-light service-title-quote text-primary">Beautiful mobile applications that engage users, enhance your business workflows, and transform your organization.</h2>
    ...
    <section class="service-block pos-relative">
		<div class="container">
			<div class="row">
         ...
         <img class="img-fluid mobile-bg" src="{{asset('public/images/mobile-mockup.jpg')}}" />
	</section>
			...
			<div class="row">
				<div class="col-md-4 mt-4">
					<div class="feature-box f-style-5 h-100 icon-grad">
						...
						<h3 class="feature-box-title">Enterprise</h3>
						<p class="feature-box-desc">Our collaborative consulting on Mobile Strategy serves as a catalyst in streamlining IT frameworks and processes with the mobile roadmap that is aligned with enterprise scenarios, policies and current systems.</p>
					</div>
				</div>
				<div class="col-md-4 mt-4">
					<div class="feature-box f-style-5 h-100 icon-grad">
						<div class="feature-box-icon"><i class="ti-palette"></i></div>
						<h3 class="feature-box-title">Business</h3>
						<p class="feature-box-desc">We map business’s needs and use cases to mobility and enable them to quickly respond to the changes. We help your organization mobilize the inter-department communication, workflows and instant information availability.</p>
					</div>
				</div>
				<div class="col-md-4 mt-4">
					<div class="feature-box f-style-5 h-100 icon-grad">
						<div class="feature-box-icon"><i class="ti-gift"></i></div>
						<h3 class="feature-box-title">Consumers</h3>
						<p class="feature-box-desc">We help brands, businesses and community organizations to build scalable app solutions that are aimed to be used everyday by consumers on a global scale, multiple times in a day.</p>
					</div>
				</div>
			</div>
		</div>
 ...
 <section class="service-block">
			...
			<div class="row">
				<div class="col-sm-12 col-lg-6 align-self-center">
					<div class="title text-left pb-4 p-lg-0 ">
						...
						<p class="fs-15">The interface is the primary touchpoint for users to interact with web and mobile based applications. Our team builds rich, powerful interfaces using the proven technologies that scale. </p>
						<div class="row">
							<div class="col-6">
								<ul class="list-group list-group-borderless list-group-icon-primary-bg">
									<li class="list-group-item"><i class="fa fa-check"></i>User Interface Development</li>
									<li class="list-group-item"><i class="fa fa-check"></i>Admin & Customer Dashboards</li>
									<li class="list-group-item"><i class="fa fa-check"></i>Fully responsive</li>
								</ul>
							</div>
							<div class="col-6">
								<ul class="list-group list-group-borderless list-group-icon-primary-bg">
									<li class="list-group-item"><i class="fa fa-check"></i>HTML, CSS/SASS, and Javascript </li>
									<li class="list-group-item"><i class="fa fa-check"></i>Reusable components</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-md-10 col-lg-6 mx-md-auto align-self-center text-center">
                    <img class="img-fluid max-width-86" src="{{asset('public/images/andorid-development.png')}}" />
				</div>
			</div>
		</div>
	</section>
    ...
    <section class="service-block">
		<div class="container">
			<div class="row">
                <div class="col-md-10 col-lg-6 mx-md-auto align-self-center text-left">

                      <img class="img-fluid max-width-86" src="{{asset('public/images/ios-development.png')}}" />
				</div>
				<div class="col-sm-12 col-lg-6 align-self-center">
					<div class="title text-left pb-4 p-lg-0 ">
						<h2>iOS Apps Development</h2>
						<p class="fs-15">With our mobile first strategy, we empower you to build scalable backend systems alloyed with API-driven architecture, that fuels additional front-end applications, websites and apps on top of the similar conditions and share the same information. We leverage the capabilities of different frameworks that fits the business needs and specific scenarios to be able to create a single data source for handling multiple applications.</p>
						<div class="row">
							<div class="col-6">
								<ul class="list-group list-group-borderless list-group-icon-primary-bg">
									<li class="list-group-item"><i class="fa fa-check"></i>Mobile CMS</li>
									<li class="list-group-item"><i class="fa fa-check"></i>API / Webservices</li>
									<li class="list-group-item"><i class="fa fa-check"></i>Authentication Services</li>
								</ul>
							</div>
							<div class="col-6">
								<ul class="list-group list-group-borderless list-group-icon-primary-bg">
									<li class="list-group-item"><i class="fa fa-check"></i>Social Integration</li>
									<li class="list-group-item"><i class="fa fa-check"></i>App Engagement with Push</li>
									<li class="list-group-item"><i class="fa fa-check"></i>Content Distribution</li>
								</ul>
							</div>
						</div>
					</div>
